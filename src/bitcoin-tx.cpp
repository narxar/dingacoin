...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dingacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dingacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dingacoin transaction") + "\n" +
              "  dingacoin-tx [options] -create [commands]   " + _("Create hex-encoded dingacoin transaction") + "\n" +
              "\n";
