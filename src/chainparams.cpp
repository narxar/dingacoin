 ...
 * database.
 *
 * CBlock(hash=000000000019d6, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=4a5e1e, nTime=1624060550, nBits=0x1e0ffff0, nNonce=99943, vtx=1)
...
{
    const char* pszTimestamp = "DingaCoin was created on June 18, 2021 at 04:55:05 PM PST in Los Angeles";
    const CScript genesisOutputScript = CScript() << ParseHex("242782153fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        // // XXX: BIP heights and hashes all need to be updated to Dingacoin values
	...
	// minyaung 
        ...
        // minyaung - Main
        genesis = CreateGenesisBlock(1624060550, 2000126814, 0x1e0ffff0, 1, 88 * COIN);
	...
	vSeeds.push_back(CDNSSeedData("54.177.147.162", "54.177.147.162", true));
        ...
        //TODO: fix this for dingacoin -- plddr
        ...
        chainTxData = ChainTxData{
            ...
            1624060550, // * UNIX timestamp of last checkpoint block
...
public:
	...
	// minyaung - Test
        genesis = CreateGenesisBlock(1624060550, 851333, 0x1e0ffff0, 1, 88 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
...
public:
	...
	// minyaung - RegTest
        genesis = CreateGenesisBlock(1624060550, 0, 0x207fffff, 1, 88 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
