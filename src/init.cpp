...
void Shutdown()
{
    ...
    RenameThread("dingacoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Dingacoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/dingacoin/dingacoin>";
    const std::string URL_WEBSITE = "<https://dingacoin.com>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("dingacoin-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Dingacoin: Do we need to do any RPC mining init here?
