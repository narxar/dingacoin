...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Dingacoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Dingacoin (as there is no actual maximum coins)
